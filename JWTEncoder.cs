...
namespace Encoders {
    class JWTEncoder {
        ...
        ///Get JWT Encoder Token for HS256 algorithm.
        ...
        ///Get JWT Encoder Token for RS256 algorithm based on Certificate Serial Number
        public string GetRs256EncoderToken(string serialNumber) {
            ...
            IDictionary<string, object> payloadData = JsonConvert.DeserializeObject<Dictionary<string, object>>(payload);
            //you can change the store location
